# 「お借りした素材一覧」生成器、完成！
![素材追加](./ReleaseImage/Ver100/バージョン表示.jpg)
![素材追加](./ReleaseImage/Ver100/サンプルプロジェクト.jpg)


「お借りした素材一覧」生成器、完成いたしました！

[詳細ページ](https://terapotan.hatenablog.jp/entry/MaterialLicenseCheckerFinal)
...
以下のリンクにある**1.0.0.zip**というファイルをダウンロードしてください。
