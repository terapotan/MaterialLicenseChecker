# 進捗
![素材追加](./ReleaseImage/alpha-7/素材追加.jpg)

1. 素材追加画面に「ファイルの場所」という項目を追加しました。
2. 素材削除機能の追加が完了しました。  
   1. 今までは、削除されたように見せかけていただけで、実際に素材が削除されたわけではありません。

# このバージョンの素材ライセンスチェッカーをダウンロードするには?
## GoogleDriveからダウンロードする
以下のリンクにある**alpha-7.zip**というファイルをダウンロードしてください。
